...
def create_member_table(db_name):
...
def create_parent_table(db_name):
...
def create_price_table(db_name):
...
def create_parent_member_table(db_name):
...
def CreateDatabase():
    ...
    create_member_table(db_name)
    create_parent_table(db_name)
    create_price_table(db_name)
    create_invoice_table(db_name)
    create_parent_member_table(db_name)
    insert_price()
